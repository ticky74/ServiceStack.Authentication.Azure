...
//            });
            ...
            _appHost = new BasicAppHost()
            {
                ConfigureAppHost = host =>
                {
                    ...
                    autoFac.Register<IApplicationRegistryService>(
                        c => new OrmLiteApplicationRegistryService(c.Resolve<IDbConnectionFactory>()));
        ...
        {
            var subject = new AzureGraphAuthenticationProvider();
        ...
        public void ShouldRequestCode()
        {
            ...
            Assert.True(result.Headers["Location"].StartsWith(
                "https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=clientid&response_type=code&redirect_uri=http%3a%2f%2flocalhost%2f&domain_hint=user@foodomain.com&scope=https%3a%2f%2fgraph.microsoft.com%2fUser.Read++https%3a%2f%2fgraph.microsoft.com%2foffline%5faccess++https%3a%2f%2fgraph.microsoft.com%2fopenid++https%3a%2f%2fgraph.microsoft.com%2fprofile"));
            ...
            Assert.Equal("user@foodomain.com", query["domain_hint"]);
        }
        ...
        public void ShouldRedirectToFailurePathIfErrorIn()
        {
            ...
            Assert.Equal("http://localhost/auth-failure?f=invalid_request&response_type=code", result.Headers["Location"]);

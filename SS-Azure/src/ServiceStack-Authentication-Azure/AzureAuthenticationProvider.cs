    ...
    public class AzureGraphAuthenticationProvider : OAuthProvider
    {
        ...
        public override object Authenticate(IServiceBase authService, IAuthSession session, Authenticate request)
        {
            ...
            if (CallbackUrl.IsNullOrEmpty())
                CallbackUrl = new Uri(authService.Request.AbsoluteUri).GetComponents(UriComponents.Path, UriFormat.SafeUnescaped);
            ...
            NameValueCollection errorInfo)
        {
            ...
            var baseUrl = authService.Request.AbsoluteUri; // .Request.GetBaseUrl();
